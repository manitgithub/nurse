...
class ExamResult extends ActiveRecord
{
    ...
    public static function getSubjectLabels()
    {
        return [
            'subject_1' => 'ผดุงครรภ์',
            'subject_2' => 'การพยาบาลมารดา ทารก',
            'subject_3' => 'การพยาบาลเด็กและวัยรุ่น',
            'subject_4' => 'การพยาบาลผู้ใหญ่',
            'subject_5' => 'การพยาบาลผู้สูงอายุ',
            'subject_6' => 'การพยาบาลจิตเวช',
            'subject_7' => 'การพยาบาลอนามัยชุมชน',
            'subject_8' => 'กฎหมายว่าด้วยวิชาชีพฯ',
        ];
    }
