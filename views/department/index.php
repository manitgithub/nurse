    ...
    <table class="min-w-full divide-y divide-gray-200">
        <thead class="bg-gray-50">
            <tr>
                ...
                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase">ชื่อสาขา</th>
        ...
        <tbody class="divide-y divide-gray-200">
            <?php foreach ($dataProvider->getModels() as $model): ?>
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 text-sm font-medium text-gray-900"><?= \yii\helpers\Html::encode($model->name) ?>
                    </td>
                    <td class="px-6 py-4">
                        <span
